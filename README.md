...
- [0xFireball/raylib_d (Deleted)](https://github.com/0xFireball/raylib_d), But there is a copy which is [Sepheus/raylib_d](https://github.com/Sepheus/raylib_d).
- [hecate-tech/ray-go](https://github.com/hecate-tech/ray-go), Golang bindings for raylib.
- [phxvyper/raylib-cppsharp](https://github.com/phxvyper/raylib-cppsharp), Raylib C# Bindings generated by CppSharp.
- [Bambofy/LuaJIT-Raylib](https://github.com/Bambofy/LuaJIT-Raylib), raylib bindings for LuaJIT, raygui is also included.
- [overdev/raylib-py-ctbg](https://github.com/overdev/raylib-py-ctbg), Python binding for the great C library raylib (ver. 2.6).
- [tomc1998/nim-raylib](https://github.com/tomc1998/nim-raylib), Generated raylib bindings from [Raylib-Forever](https://github.com/Guevara-chan/Raylib-Forever), with some extra vector operators for convenience.
